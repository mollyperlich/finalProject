d3.csv('https://finalprojectcalendardata.s3-us-west-2.amazonaws.com/Conditional_Buy_Quantile.csv').then(buy=>{
    d3.csv('https://finalprojectcalendardata.s3-us-west-2.amazonaws.com/Conditional_Sell_Quantile.csv').then(sell=>{
