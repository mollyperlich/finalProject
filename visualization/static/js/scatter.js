d3.json('https://finalprojectcalendardata.s3-us-west-2.amazonaws.com/News_Links.json').then(newslinks=>{
    d3.json('https://finalprojectcalendardata.s3-us-west-2.amazonaws.com/Graph_Data.json').then(d=>{
